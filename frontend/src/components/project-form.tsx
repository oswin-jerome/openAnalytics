    ...
    return (
        <form className=" gap-6 flex flex-col justify-between h-full w-full  ">
               ...
               <div className="grid gap-3 pl-4 pr-6 " >
                ...
                <Button className="border-accent border-b-2 bg-gray-200 text-black  max-w-[10rem] md:w-full shadow-gray-400 shadow-sm ">cancel</Button>
                <Button className=" max-w-xs md:w-full shadow-sm  ">Create</Button>
                </div>
